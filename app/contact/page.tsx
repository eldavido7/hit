        ...
        <div className="min-h-screen ">
            ...
            <div className="text-center relative h-[500px]">
                <div className="absolute top-0 left-0 w-full h-full z-10 overflow-hidden">
                    <Image src="/contactbg.png" alt="Background frame" fill className="object-cover object-center" />
                </div>
                ...
                <div className="relative z-20 max-w-2xl mx-auto pt-40">
                    ...
                    <p className="text-lg text-white mb-8 max-w-2xl md:px-0 px-6 mx-auto leading-relaxed">
                        Whether you want to collaborate, share your story, or simply connect, we’re here to listen.
                    </p>
                </div>
            </div>
            ...
            <section className="bg-white rounded-t-[50px] -mt-16 relative z-30 py-16 px-6">
                <div className="max-w-[1440px] mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-4xl md:text-5xl font-cormorant text-gray-900 mb-4">Get in Touch With Us</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Collaborate, ask questions, or schedule a chat, reach us by form, Calendly, phone, or email.
                        </p>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="border border-gray-200 rounded-2xl p-8">
                            <h3 className="text-2xl font-cormorant text-gray-900 mb-4">Send Us an Email</h3>
                            <p className="text-gray-600 mb-8">
                                Have a question, inquiry, or suggestion? Fill out the form below, and we'll get back to you as soon as
                                possible.
                            </p>
                                    ...
                                    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
                                        <div className="bg-white rounded-2xl p-6 max-w-md mx-4 relative">
                                            ...
                                            <div className="text-center">
                                                ...
                                                />
                                                <h3 className="text-3xl font-semibold text-gray-900 mb-2">Thank you for reaching out!</h3>
                        ...
                        <div className="space-y-6">
                                ...
                                <div className="space-y-6">
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">hello@herimmigranttales.org</p>
                                        </div>
                                        <div>
                                            <div className="grid grid-cols-1 items-center gap-3 mb-2">
                                                <Mail className="w-4 h-4 text-[#bf5925]" />
                                                <span className="font-medium text-gray-900">Email 2</span>
                                            </div>
                                            <p className="text-gray-600 text-sm">hello@herimmigranttales.com</p>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-[url('/contactbg1.png')] bg-cover bg-center border border-[#bf5925] text-center rounded-2xl p-8 text-white">
                                <h3 className="text-2xl font-cormorant mb-4">Book a Conversation with Us</h3>
