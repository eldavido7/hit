            ...
            <section className="relative py-20 px-6 bg-white z-10">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-cormorant text-[#353336] mb-4">Upcoming Events</h2>
                        <p className="text-lg text-[#353336] max-w-3xl mx-auto leading-relaxed">
                            Workshops, panels, and meetups where immigrant women and allies connect, share stories, and spark change
                            together
                        </p>
                    </div>
                    {events.length === 0 ? (
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold text-[#353336] mb-4">Subscribe to Our Newsletter</h3>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 leading-relaxed">Work with us to amplify voices and create lasting impact.</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold text-[#353336] mb-4">Support the Mission</h3>
                            <p className="text-gray-600 leading-relaxed">
